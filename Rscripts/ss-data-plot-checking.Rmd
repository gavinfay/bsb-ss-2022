...
#SS_plots(replist, plot = c(1:25), dir = here::here(),pdf = TRUE, png=FALSE)
...
runs_to_compare <- c(276, 283, 277, 284, 282, 281)
...
SSplotComparisons(mod.sum, 
                  ...
                  legendloc = "topleft",
                  #legendloc = "topright",
                  indexfleets = purrr::map(1:6,~c(13, 14)))
