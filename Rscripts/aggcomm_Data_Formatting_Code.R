...
SS_BSB_dat1 = list(
  ...
  "###############################################",
  "#_MA_Spring_Trawl",
  MA.spr.std = data.frame(year = MA.spr.agg[MA.spr.agg$Type == "Std", 1], seas = "4", index = "9",obs = MA.spr.agg[MA.spr.agg$Type == "Std", 2], CV = MA.spr.agg[MA.spr.agg$Type == "Std", 5]), 
  "#_MA_Fall_Trawl",
  MA.fall.std = data.frame(year = MA.fall.agg[MA.fall.agg$Type == "Std", 1], seas = "10", index = "10",obs = MA.fall.agg[MA.fall.agg$Type == "Std", 2], CV = MA.fall.agg[MA.fall.agg$Type == "Std", 5]),
  "#_RI_Spring_Trawl",
  RI.spr.std = data.frame(year = RI.spr.agg[RI.spr.agg$Type == "Std", 1], seas = "4", index = "11",obs = RI.spr.agg[RI.spr.agg$Type == "Std", 2], CV = RI.spr.agg[RI.spr.agg$Type == "Std", 5]),
  "#_RI_Fall_Trawl",
  RI.fall.std = data.frame(year = RI.fall.agg[RI.fall.agg$Type == "Std", 1], seas = "10", index = "12",obs = RI.fall.agg[RI.fall.agg$Type == "Std", 2], CV = RI.fall.agg[RI.fall.agg$Type == "Std", 5]),  #survey is new, how to number?
  "#_CT_Spring_Trawl",
  CT.spr.std = data.frame(year = CT.spr.agg[CT.spr.agg$Type == "Std", 1], seas = "4", index = "13",obs = CT.spr.agg[CT.spr.agg$Type == "Std", 2], CV = CT.spr.agg[CT.spr.agg$Type == "Std", 5]),
  "#_CT_Fall_Trawl",
  CT.fall.std = data.frame(year = CT.fall.agg[CT.fall.agg$Type == "Std", 1], seas = "10", index = "14",obs = CT.fall.agg[CT.fall.agg$Type == "Std", 2], CV = CT.fall.agg[CT.fall.agg$Type == "Std", 5]),
  "#_NY_Spring_Trawl_Age1",
  NY.mean = data.frame(year = NY.agg[, 1], seas = "4", index = "15",obs = NY.agg[, 2], CV = NY.agg[, 4]),
  "#_NJ_Trawl",
  NJ.mean = data.frame(year = NJ[, 1], seas = "4", index = "16",obs = NJ[, 2], CV = NJ[, 4]),
  "#_DE_Trawl",
  DE.mean = data.frame(year = DE.agg[-13, 1], seas = "4", index = "17",obs = DE.agg[-13, 2], CV = DE.agg[-13, 3]) |> filter(se!=0),  #Note: DE doesn't have a CV so CV is actually a SE, removed missing 1990 (the - row 13)
  "#_MD_Trawl",
  MD.mean = data.frame(year = MD.agg[, 1], seas = "4", index = "18",obs = exp(MD.agg[, 3]), CV = MD.agg[, 4]) |> filter(YEAR!=1996),  #Note: MD doesn't have a CV so CV is actually a SE, also index is a "LogMean"
  "#_VIMS_Trawl",
  VA.mean = data.frame(year = vims.agg[-32, 1], seas = "4", index = "19",obs = vims.agg[-32, 2], CV = 0.67),  #Note: No uncertainty estimate so just added 0.67 from previous dat file
  "#_NEAMAP_N_Spring_Trawl",
  NEAMAP.N.spr.mean = data.frame(year = neamap.spr.agg[neamap.spr.agg$BSB.Region == "NORTH", 2], seas = "4", index = "20",obs = neamap.spr.agg[neamap.spr.agg$BSB.Region == "NORTH", 3], CV = neamap.spr.agg[neamap.spr.agg$BSB.Region == "NORTH", 5]/neamap.spr.agg[neamap.spr.agg$BSB.Region == "NORTH", 3]), 
  "#_NEAMAP_S_Spring_Trawl",
  NEAMAP.S.spr.mean = data.frame(year = neamap.spr.agg[neamap.spr.agg$BSB.Region == "SOUTH", 2], seas = "4", index = "21",obs = neamap.spr.agg[neamap.spr.agg$BSB.Region == "SOUTH", 3], CV = neamap.spr.agg[neamap.spr.agg$BSB.Region == "SOUTH", 5]/neamap.spr.agg[neamap.spr.agg$BSB.Region == "SOUTH", 3]),
  "#_NEAMAP_N_Fall_Trawl",
  NEAMAP.N.fall.mean = data.frame(year = neamap.fall.agg[neamap.fall.agg$BSB.Region == "NORTH", 2], seas = "10", index = "22",obs = neamap.fall.agg[neamap.fall.agg$BSB.Region == "NORTH", 3], CV = neamap.fall.agg[neamap.fall.agg$BSB.Region == "NORTH", 5]/neamap.fall.agg[neamap.fall.agg$BSB.Region == "NORTH", 3]), 
  "#_NEAMAP_S_Fall_Trawl",
  NEAMAP.S.fall.mean = data.frame(year = neamap.fall.agg[neamap.fall.agg$BSB.Region == "SOUTH", 2], seas = "10", index = "23",obs = neamap.fall.agg[neamap.fall.agg$BSB.Region == "SOUTH", 3], CV = neamap.fall.agg[neamap.fall.agg$BSB.Region == "SOUTH", 5]/neamap.fall.agg[neamap.fall.agg$BSB.Region == "SOUTH", 3]),
  "#_NEFSC_N_Spring_Trawl",
  NEFSC.N.spr.mean = data.frame(year = nefsc.agg[nefsc.agg$STOCK_ABBREV == "NORTH" & nefsc.agg$SEASON == "SPRING" & nefsc.agg$SERIES == "ALBATROSS", 3], seas = "4", index = "24",obs = nefsc.agg[nefsc.agg$STOCK_ABBREV == "NORTH" & nefsc.agg$SEASON == "SPRING" & nefsc.agg$SERIES == "ALBATROSS", 9], CV = nefsc.agg[nefsc.agg$STOCK_ABBREV == "NORTH" & nefsc.agg$SEASON == "SPRING" & nefsc.agg$SERIES == "ALBATROSS", 12]), 
  "#_NEFSC_S_Spring_Trawl",
  NEFSC.S.spr.mean = data.frame(year = nefsc.agg[nefsc.agg$STOCK_ABBREV == "SOUTH" & nefsc.agg$SEASON == "SPRING" & nefsc.agg$SERIES == "ALBATROSS", 3], seas = "4", index = "25",obs = nefsc.agg[nefsc.agg$STOCK_ABBREV == "SOUTH" & nefsc.agg$SEASON == "SPRING" & nefsc.agg$SERIES == "ALBATROSS", 9], CV = nefsc.agg[nefsc.agg$STOCK_ABBREV == "SOUTH" & nefsc.agg$SEASON == "SPRING" & nefsc.agg$SERIES == "ALBATROSS", 12]),
  "#_Bigelow_N_Spring_Trawl",
  Big.N.spr.mean = data.frame(year = nefsc.agg[nefsc.agg$STOCK_ABBREV == "NORTH" & nefsc.agg$SEASON == "SPRING" & nefsc.agg$SERIES == "BIGELOW", 3], seas = "4", index = "26",obs = nefsc.agg[nefsc.agg$STOCK_ABBREV == "NORTH" & nefsc.agg$SEASON == "SPRING" & nefsc.agg$SERIES == "BIGELOW", 9], CV = nefsc.agg[nefsc.agg$STOCK_ABBREV == "NORTH" & nefsc.agg$SEASON == "SPRING" & nefsc.agg$SERIES == "BIGELOW", 12]), 
  "#_Bigelow_S_Spring_Trawl",
  Big.S.spr.mean = data.frame(year = nefsc.agg[nefsc.agg$STOCK_ABBREV == "SOUTH" & nefsc.agg$SEASON == "SPRING" & nefsc.agg$SERIES == "BIGELOW", 3], seas = "4", index = "27",obs = nefsc.agg[nefsc.agg$STOCK_ABBREV == "SOUTH" & nefsc.agg$SEASON == "SPRING" & nefsc.agg$SERIES == "BIGELOW", 9], CV = nefsc.agg[nefsc.agg$STOCK_ABBREV == "SOUTH" & nefsc.agg$SEASON == "SPRING" & nefsc.agg$SERIES == "BIGELOW", 12]),
  ####NOTE: Winter survey not broken N-S, so couldn't update, but should be the same as before?
  "#_RecCPUE_N_spr",
  RecCPUE.N.mean = data.frame(year = RecCPA.agg[RecCPA.agg$Region == "North", 2], seas = "4", index = "35",obs = RecCPA.agg[RecCPA.agg$Region == "North", 3], CV = 0.38), #Note: Using previous average for RecCPUE CV until can get from Jeff
  "#_RecCPUE_S_spr",
  RecCPUE.S.mean = data.frame(year = RecCPA.agg[RecCPA.agg$Region == "South", 2], seas = "4", index = "36",obs = RecCPA.agg[RecCPA.agg$Region == "South", 3], CV = 0.25), #Note: Using previous average for RecCPUE CV until can get from Jeff
  "#_VAST_N_spr",
  VAST.N.spr = data.frame(year = spring_N_index$Year, seas = "4", index = "31", obs = spring_N_index$Index, CV = spring_N_index$Index_SD/spring_N_index$Index),
  "#_VAST_S_spr",
  VAST.S.spr = data.frame(year = spring_S_index$Year, seas = "4", index = "32", obs = spring_S_index$Index, CV = spring_S_index$Index_SD/spring_S_index$Index),
  "#_VAST_N_fall",
  VAST.N.fall = data.frame(year = fall_N_index$Year, seas = "10", index = "33", obs = fall_N_index$Index, CV = fall_N_index$IndexSD/fall_N_index$Index),
  "#_VAST_S_fall",
  VAST.S.fall = data.frame(year = fall_S_index$Year, seas = "10", index = "34", obs = fall_S_index$Index, CV = fall_S_index$Index_SD/fall_S_index$Index),
  
  "###############################################",
  "##  Discard Data",
  "###############################################",
  "#Disc_North_Comm_1",
  N.Trawl.spr.Disc = comdisc.gr.sem %>% filter(REGION == "NORTH", SEMESTER == 1) %>% group_by(YEAR) %>% summarise(Discards=round(sum(Dead.Disc.mt),digits=0)) %>%
  ...
  "#Disc_South_Comm_1",
  S.Trawl.spr.Disc = comdisc.gr.sem %>% filter(REGION == "SOUTH", SEMESTER == 1) %>% group_by(YEAR) %>% summarise(Discards=round(sum(Dead.Disc.mt), digits=0)) %>%
    add_column(Seas = 4, fleet = 2, 
               .after = "YEAR") %>%
    add_column(CV = 0.3, 
               .after = "Discards") %>% data.frame,
  "#Disc_North_Comm_2",
  N.Trawl.fall.Disc = comdisc.gr.sem %>% filter(REGION == "NORTH", SEMESTER == 2) %>% group_by(YEAR) %>% summarise(Discards=round(sum(Dead.Disc.mt), digits=0)) %>%
    add_column(Seas = 10, fleet = 3, 
               .after = "YEAR") %>%
    add_column(CV = 0.3, 
               .after = "Discards") %>% data.frame,  
  "#Disc_South_Comm_2",
  S.Trawl.spr.Disc = comdisc.gr.sem %>% filter(REGION == "SOUTH", SEMESTER == 2) %>% group_by(YEAR) %>% summarise(Discards=round(sum(Dead.Disc.mt), digits=0)) %>%
    add_column(Seas = 10, fleet = 4, 
               .after = "YEAR") %>%
    add_column(CV = 0.3, 
               .after = "Discards") %>% data.frame,
  "#Disc_North_Rec_1",
  N.Rec.spr.Disc = rec.agg.region.sem %>% filter(REGION == "North", SEMESTER == 1) %>% group_by(YEAR) %>% summarise(Discards=round(sum(B2_dead)/1000, digits=0)) %>%
    add_column(Seas = 4, fleet = 5, 
               .after = "YEAR") %>%
    add_column(CV = 0.3, 
               .after = "Discards") %>% data.frame,  ###Just made up CV for now, need to discuss and B2_dead or all B2s
  "#Disc_South_Rec_1",
  S.Rec.spr.Disc = rec.agg.region.sem %>% filter(REGION == "South", SEMESTER == 1) %>% group_by(YEAR) %>% summarise(Discards=round(sum(B2_dead)/1000, digits=0)) %>%
    add_column(Seas = 4, fleet = 6, 
               .after = "YEAR") %>%
    add_column(CV = 0.3, 
               .after = "Discards") %>% data.frame,
  "#Disc_North_Rec_2",
  N.Rec.fall.Disc = rec.agg.region.sem %>% filter(REGION == "North", SEMESTER == 2) %>% group_by(YEAR) %>% summarise(Discards=round(sum(B2_dead)/1000,digits=0)) %>%
    add_column(Seas = 10, fleet = 7, 
               .after = "YEAR") %>%
    add_column(CV = 0.3, 
               .after = "Discards") %>% data.frame,  
  "#Disc_South_Rec_2",
  S.Rec.fall.Disc = rec.agg.region.sem %>% filter(REGION == "South", SEMESTER == 2) %>% group_by(YEAR) %>% summarise(Discards=round(sum(B2_dead)/1000,digits=0)) %>%
...
comdisc_samp_trawl <- comdisc.nhaul.fleet |>
  ...
  mutate(season = ifelse(semester==1,4,10)) |>
  group_by(index, year, season) |>
  summarize(nsamp = sum(trawl, na.rm = TRUE) + sum(non_trawl, na.rm = TRUE), .groups = "drop") |>
  mutate(part = 1) |>
  filter(nsamp > 0) |>
  I()
#comdisc_samp_trawl
...
nu_agelens <- fishery.age.data |>
  ...
  left_join(lenbins) |>
  filter(region != "UNK") |> #some unknown region entries
  group_by(year, region, semester, ibin, age) |>
  summarize(num = n()) |>
  ungroup() |>
  group_by(year, region, semester, ibin) |>
  complete(age = 0:15, fill = list(num = 0)) |>
  mutate(nsamp = sum(num, na.rm=TRUE),
         aprop = num/nsamp) |>
  ungroup() |>
...
recaps <- read_table("tag_recap_agg.txt") %>% 
  group_by(tg, year, season, nufleet) %>% 
  summarize(number = sum(number)) %>% 
  ungroup() %>% 
  rename(fleet = nufleet)
...
write("###", file = file.path("aggcomm_SS_BSB_dat.txt"))
xx <- map(SS_BSB_dat1, write.table,
          file = file.path("aggcomm_SS_BSB_dat.txt"),
          row.names = FALSE,
          quote = FALSE,
          col.names = FALSE,
          append = TRUE)
...
write("##  Fishery Length Composition Data", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
write("###############################################", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
...
write("###############################################", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
write("##  Index Length Composition Data", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
write("###############################################", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
...
write("###############################################", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
write("##  Age Composition Data", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
write("###############################################", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
...
write("###############################################", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
write("##  Ghost Age Composition Data", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
write("###############################################", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
...
write("###############################################", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
write("##  Tag Recaptures Data", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
write("###############################################", file = file.path("aggcomm_SS_BSB_dat.txt"), append = TRUE)
write.table(recaps, 
            file = "aggcomm_SS_BSB_dat.txt", 
            append = TRUE, 
